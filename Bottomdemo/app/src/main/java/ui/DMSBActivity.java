...
public class DMSBActivity extends Activity {
...
//    private PermissionHelper mPermissionHelper;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dmsb);
    ...
    public void initfile(String modelName){
        if(modelName.equals("dmsb")){
            File file_1 = new File(Environment.getExternalStorageDirectory(),"dmsbtexcoords.txt");
            File file_2 = new File(Environment.getExternalStorageDirectory(),"dmsbmenverts.txt");
            File file_3 = new File(Environment.getExternalStorageDirectory(),"dmsbnormals.txt");
            File file_4 = new File(Environment.getExternalStorageDirectory(),"dmsb.jpg");
...
//                mfilestate_dmsbtexcoords.setText("此模型未下载");
    ...
    public void down_dmsbtexcoords_onClick(View view) throws IOException {
        String down_file_name_1="dmsbtexcoords.txt";
        String down_file_name_2="dmsbnormals.txt";
        String down_file_name_3="dmsbmenverts.txt";
        String down_file_name_4="dmsb.jpg";
        String dmsbtexcoords_down_url_1="http://47.98.170.72:8084/downfile/dmsbtexcoords.txt";
        String dmsbtexcoords_down_url_2="http://47.98.170.72:8084/downfile/dmsbnormals.txt";
        String dmsbtexcoords_down_url_3="http://47.98.170.72:8084/downfile/dmsbmenverts.txt";
        String dmsbtexcoords_down_url_4="http://47.98.170.72:8084/downfile/damenshibei.jpg";
    ...
    public void delete_dmsbtexcoords_onClick(View view) throws IOException {
        String file_name_delete_1="dmsbtexcoords.txt";
        String file_name_delete_2="dmsbnormals.txt";
        String file_name_delete_3="dmsbmenverts.txt";
        String file_name_delete_4="dmsb.jpg";
...
//                Looper.loop();
    ...
    public void goLuncher_dmsb(View view){

        Intent intent = new Intent(DMSBActivity.this,app.ImageTargets.class);
...
//        Intent intent = new Intent(DMSBActivity.this, ListActivity.class);
//        startActivity(intent);
        finish();
