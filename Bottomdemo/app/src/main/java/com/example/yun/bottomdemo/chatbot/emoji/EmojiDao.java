package com.example.yun.bottomdemo.chatbot.emoji;

import android.database.Cursor;
import android.database.sqlite.SQLiteDatabase;

import com.example.yun.bottomdemo.chatbot.MyApplication;
...
//        File dir = new File("data/data/" + "com.hrl.chaui" + "/databases");
        File dir = new File("data/data/" + "com.example.yun.bottomdemo" + "/databases");
